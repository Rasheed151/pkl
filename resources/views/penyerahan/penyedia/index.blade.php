...
<main id="mainContent">
    ...
    <div class="mt-10 relative w-full max-w-8xl bg-white shadow-lg rounded-lg overflow-hidden">
        <div class="p-5">
            <div class="flex items-center justify-between mb-4">
                ...
                <a class="m-2 rounded-2xl text-white bg-blue-700 hover:bg-blue-800 p-2" href="{{ route('testing.pdf', $kegiatanId) }}"> Print </a>
            </div>
    ...
    <script>
        window.onload = function() {
            document.getElementById('pdfFrame').src = '/testing-pdf/view/{{ $kegiatanId }}';
