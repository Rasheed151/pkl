                    ...
                    <table
                        ...
                        <tbody>
                            ...
                            <tr
                                ...
                                <td class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">{{$data -> rkp_data -> officials_data ->name}}</td>
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('Schedule.index', $data->id) }}" method="get" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <p class="isi-lihat">{{ $data->tpk_data -> head_name }}</p>
                            </div>
                            <div class="mb-3">
                                <label {{ $data->id }} class="form-label">Sekertaris TPK</label>
                                <p class="isi-lihat">{{ $data->tpk_data -> secretary_name }}</p>
                            </div>
                            <div class="mb-3">
                                <label {{ $data->id }} class="form-label">Anggota TPK</label>
                                <p class="isi-lihat">{{ $data->tpk_data -> member_name }}</p>
                            </div>
                            <div class="mb-3">
