...
<main id="mainContent">
    ...
    <!-- Card 1 -->
    <div class="w-full max-w-8xl py-1 bg-##d7e0ea  rounded-lg overflow-hidden mx-auto mt-10">


        <div class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div class="p-5">
                <div class="flex items-center justify-between mb-4">
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white"> Spesifikasi Teknis untuk Kegiatan {{ $activity_name}}</h2>
                ...
                <div class="overflow-x-auto">
                    ...
                    <table
                        ...
                        <tbody>
                            ...
                            <tr
                                ...
                                <td class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">{{$data -> type}}</td>
                                <td class="px-6 py-4 text-center border-b border-gray-200 dark:border-gray-700"
                                    style="display: flex; justify-content: space-between;">
                                    <a href="{{ route('technical_specifications.edit', $data->id,$rkp_id) }}"
                                        class="mx-2 text-yellow-600 dark:text-yellow-500 hover:text-yellow-700 dark:hover:text-yellow-400"
                                        title="Edit Data">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('technical_specifications.destroy', $data->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
                    ...
                    <a href="{{ route('technical_specifications.pdf',  $rkp_id) }}"
                        ...
                        Cetak Data Teknis Kegiatan {{ $activity_name}}
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content bg-white shadow-2xl rounded-xl">
                    <div class="modal-header border-b border-gray-200 py-4 px-6">
                        <h5 class="modal-title text-2xl font-bold text-gray-800" id="staticModalLabel">Tambah Data Spesifikasi Teknis</h5>
                        <button type="button" class="btn-close text-gray-400 hover:text-gray-600" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body p-6">
                        <form id="dataForm" action="{{ route('technical_specifications.store') }}" method="POST">
                            @csrf
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="specification" placeholder="Masukkan spesifikasi"
                                        class="mt-2 block w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                </div>
