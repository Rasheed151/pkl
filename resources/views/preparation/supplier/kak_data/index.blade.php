                        ...
                        <tbody>
                            ...
                            <tr
                                ...
                                <td class="px-6 py-4 text-center border-b border-gray-200 dark:border-gray-700" style="display: flex; justify-content: space-between;">
                                    ...
                                    <a href="{{ route('kak_data.edit', $data->id) }}"
                                        class="mx-2 text-yellow-600 dark:text-yellow-500 hover:text-yellow-700 dark:hover:text-yellow-400"
                                        title="Edit Data">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('kak_data.destroy', $data->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content bg-white shadow-2xl rounded-xl">
                    ...
                    <div class="modal-body p-6">
                        <form id="dataForm" action="{{ route('kak_data.store') }}" method="POST">
                            @csrf
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="background" placeholder="Masukkan Latar Belakang"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('kak_data.index', $data->id) }}" method="get" enctype="multipart/form-data">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <p class="isi-lihat">{{ $data->background }}</p>
                            </div>
                            <div class="mb-3">
                                <label {{ $data->id }} class="form-label">sasaran Manfaat</label>
                                <p class="isi-lihat">{{ $data->rkp_data->benefit_target }}</p>
                            </div>
                            <div class="mb-3">
                                <label {{ $data->id }} class="form-label">Cara Pengadaan</label>
                                <p class="isi-lihat">{{ $data->announcement->procurement_method }}</p>
                            </div>
                            <div class="mb-3">
