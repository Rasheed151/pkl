            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content bg-white shadow-2xl rounded-xl">
                    ...
                    <div class="modal-body p-6">
                        <form id="dataForm" action="{{ route('supplier_data.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="modal-footer border-t border-gray-200 py-4 px-6">
                                ...
                                <button type="submit" id="submitButton" class="btn btn-primary bg-blue-500 text-white hover:bg-blue-600">
                                    Simpan
                                </button>
                            </div>
                        </form>
