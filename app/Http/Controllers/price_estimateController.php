...
class price_estimateController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('preparation.supplier.price_estimate.index', compact('rkp_id', 'activity_name', 'price_estimate'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('preparation.supplier.price_estimate.index', compact('rkp_id'));
    }
    ...
    public function store(Request $request)
    {
        ...
        price_estimate::create([
            ...
            return redirect()->route('rab_data.index_swakelola', ['rkp_id' => $request->rkp_id])
                ->with('success', 'Data spesifikasi teknis berhasil ditambahkan');
        }
    }
    ...
    public function destroy($id)
    {
        ...
        if (Announcement::where('rkp_id', $rkp_id)
            ->where('procurement_method', 'Penyedia')
            ->exists()) {
            ...
            return redirect()->route('rab_data.index_swakelola', ['rkp_id' => $rkp_id])
                ->with('success', 'Data spesifikasi teknis berhasil ditambahkan');
        }
    }
    ...
    public function index_swakelola(Request $request)
    {
        ...
        return view('preparation.swakelola.rab_data.index', compact('rkp_id', 'activity_name', 'price_estimate'));
    }
}
